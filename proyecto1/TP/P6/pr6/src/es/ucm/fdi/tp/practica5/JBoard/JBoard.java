...
public class JBoard extends JComponent implements GameObserver {
	...
	private int _CELL_HEIGHT = 0; // Alto de la casilla del tablero
	private int _CELL_WIDTH = 0; //Ancho de la casilla del tablero
	...
	private void fillBoard(Graphics g) {
		...
		if(board != null){
			...
			_CELL_HEIGHT = this.getWidth()/board.getCols();
	...
	private void drawCell(int row, int col, Graphics g) {
		...
		case RECTANGLE:		
			...
			g.setColor(Color.BLACK);//Interior
