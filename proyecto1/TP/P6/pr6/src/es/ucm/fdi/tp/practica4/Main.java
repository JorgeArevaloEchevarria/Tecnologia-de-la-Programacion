...
public class Main {
	...
	/**
	 * Builds the obstacle (-o or --obstacles) CLI option.
	 * 
	 * Construye la opcion CLI de obstaculos
	 * 
	...
	/**
	 * Parses the obstacle option (-o or --obstacles). It sets the value of
	 * {@link #obstacles} accordingly.
	 * 
	 * <p>
	 * Extrae la opcion obstacles (-o) y asigna el valor de {@link #obstacles}.
	 * 
	 * @param line
	...
	private static Option constructGameOption() {
		...
		optionInfo += "). By default, " + DEFAULT_GAME.getId() + ".";
